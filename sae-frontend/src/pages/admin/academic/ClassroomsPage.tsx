    ...
    <Box sx={{ minHeight: '100%', background: 'linear-gradient(160deg,#f0fdf4 0%,#f8fafc 50%,#f0fdf4 100%)', p: 3, position: 'relative', overflow: 'hidden' }}>
      ...
      <Box sx={{ position: 'relative', zIndex: 1 }}>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
          <Box>
            <Typography variant="h5" fontWeight={700} color="#0A1628">Turmas</Typography>
            <Typography variant="body2" color="text.secondary" sx={{ mt: 0.5 }}>Gestão de turmas académicas</Typography>
          </Box>
