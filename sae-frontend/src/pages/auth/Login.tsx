  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: '#f0f2f5', display: 'flex', alignItems: 'center', justifyContent: 'center', p: 2 }}>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}
            ...
            <Box>
              ...
              <TextField
                ...
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start"><PhoneIcon sx={{ color: '#bdbdbd' }} /></InputAdornment>
                  ),
                }}
            ...
            <Box>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                ...
                <Link
                  ...
                  sx={{ cursor: 'pointer', color: '#00A651', fontWeight: 600, fontSize: '0.85rem' }}
                >
                  Esqueceu a senha?
                </Link>
              </Box>
              <TextField
                ...
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start"><LockIcon sx={{ color: '#bdbdbd' }} /></InputAdornment>
                  ),
                  endAdornment: (
            ...
            <Box sx={{ pt: 2, borderTop: '1px solid #e0e0e0', textAlign: 'center' }}>
              <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
                ...
                <Link
                  ...
                  sx={{ cursor: 'pointer', color: '#00A651', fontWeight: 600 }}
                >
      ...
      <Dialog open={forgotOpen} onClose={closeForgot} maxWidth="xs" fullWidth
        ...
        <DialogTitle sx={{ fontWeight: 700, pb: 1 }}>Recuperar Palavra-passe</DialogTitle>
        <DialogContent>
          {forgotSuccess ? (
            ...
            <>
              ...
              <TextField
                ...
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start"><EmailIcon sx={{ color: '#bdbdbd' }} /></InputAdornment>
                  ),
                }}
        ...
        <DialogActions sx={{ px: 3, pb: 3, gap: 1 }}>
          <Button onClick={closeForgot} variant="outlined" sx={{ borderRadius: 2, textTransform: 'none' }}>
          ...
          {!forgotSuccess && (
            <Button
              ...
              sx={{ bgcolor: '#00A651', borderRadius: 2, textTransform: 'none', fontWeight: 700, '&:hover': { bgcolor: '#008C44' } }}
            >
