...
// // return new ResponseEntity<>(Map.of("error", responseMessage),
// // HttpStatus.BAD_REQUEST);
// // }

// // // Return the response with the OTP message.
// // return new ResponseEntity<>(Map.of("message", responseMessage),
// // HttpStatus.ACCEPTED);
...
// @PostMapping("/signup")
// public ResponseEntity<?> signup(@RequestBody RegisterRequestDTO
// registerRequest) throws Exception {
// UserEntity user = userService.createUser(registerRequest);
// return new ResponseEntity<>(user, HttpStatus.CREATED);
// }

// @PostMapping("/signup/professor")
// public ResponseEntity<?> signupProfessor(@RequestBody ProfessorRegisterDTO
// registerRequest) throws Exception {
// ProfessorProfileEntity profile =
// userService.createProfessor(registerRequest);
// return new ResponseEntity<>(profile, HttpStatus.CREATED);
// }

// @PostMapping("/signup/student")
// public ResponseEntity<?> signupStudent(@RequestBody StudentRegisterDTO
// registerRequest) throws Exception {
...
// @PostMapping("/login")
// public ResponseEntity<?> signin(@RequestBody AuthenticationRequestDTO
...
// AuthenticationResponseDTO(principal.getFullname(),
// principal.getUsername(),
// jwt, userService.findTransactionsByRole(principal),
// UserRoleValidator.validate(principal.getRole().getRole().name()));
