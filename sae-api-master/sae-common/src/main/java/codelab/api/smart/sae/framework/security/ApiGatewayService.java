...
public class ApiGatewayService {
	...
	public String authenticate(String contractKey) {
		...
		ResponseEntity<String> response = restTemplate.exchange(ApiGatewayService.GATEWAY_AUTH_URL, HttpMethod.POST, request,
				String.class);
...
//
//		ResponseEntity<IntegPayload> response = restTemplate.exchange(ApiGatewayService.GATEWAY_REQUEST_URL, HttpMethod.POST, request,
//				IntegPayload.class);
//
//		return response;
//	}
